  ...
  return (
    <React.Fragment>
      <div className="bmc-card-full">
        ...
        <DocumentCard onUpdate={handleCallback} initialRows={data.documentDetails} tenantId={tenantId} AddOption={false} AllowRemove={false} />
        <UserOthersDetails onUpdate={handleCallback} initialRows={data.UserOtherDetails} tenantId={tenantId} AllowEdit={false} />
        <QualificationCard initialRows={data.UserQualification} tenantId={tenantId} AddOption={false} AllowRemove={false} onUpdate={handleCallback} />
        <BankDetails onUpdate={handleCallback} initialRows={data.UserBank} tenantId={tenantId} AddOption={false} AllowRemove={false} />
