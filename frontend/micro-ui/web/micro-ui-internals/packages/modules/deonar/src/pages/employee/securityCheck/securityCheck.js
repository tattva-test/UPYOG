...
import { CardLabel, Toast } from "@upyog/digit-ui-react-components";
    ...
    <React.Fragment>
      <div className="bmc-card-full">
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="bmc-card-row" style={{ display: "flex", gap: "10px" }}>
            <div className="bmc-row-card-header" style={{ display: "flex", flexDirection: "column", width: "50%" }}>
              <div className="bmc-card-row">
                <div className="bmc-title">{t("SECURITY_CHECK_DETAILS")}</div>
            ...
            <div className="bmc-row-card-header" style={{ width: "50%" }}>
              <div className="bmc-card-row">
                <CustomTable
                  ...
                  tableClassName="deonar-custom-scroll deonar-scrollable-table"
                  data={tableData}
                  disableSort={false}
                  autoSort={false}
            ...
            <CustomModal isOpen={isModalOpen} onClose={toggleModal}>
              <DynamicRowGenerator
                ...
                inputLabel="Animal Token Number"
          ...
          <SubmitButtonField control={control} disabled={!isAnimalAdded} />
        </form>
      </div>
      {toast && (
        <Toast
          error={toast.key === "error"}
          label={t(toast.key === "success" ? "SECURITY_CHECK_DATA_SAVED_SUCCESSFULLY" : toast.action)}
