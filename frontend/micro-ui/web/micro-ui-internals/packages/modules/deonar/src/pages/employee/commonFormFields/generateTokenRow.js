    ...
    <div>
      ...
      <div className="bmc-table-container" style={{ padding: "1rem" }}>
        <table className="bmc-hover-table">
          ...
          <tbody>
            <tr>
              <td data-label={t(dropdownLabel)} style={{ textAlign: "left", paddingTop: "16px" }}>
                <Controller
                  control={control}
                  name="dropdown"
              ...
              <td data-label={t(inputLabel)} style={{ textAlign: "left" }}>
                <Controller
                  control={control}
                  name="input"
                  rules={{ required: t("CORE_COMMON_REQUIRED_ERRMSG") }}
              ...
              <td data-label={t(generateLabel)}>
                <button
                  type="button"
                  onClick={() => handleGenerateRows(currentRow, rows, setRows, setCurrentRow, onRowsUpdate)}
                  style={{ padding: "2px 20px", outline: "none", background: "green", borderRadius: "15px", marginBottom: "14px", color: "white" }}
                >
